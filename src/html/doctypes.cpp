...
/* Command-line: gperf -k '*' --output-file=doctypes.cpp doctypes.gperf  */
...
#line 7 "doctypes.gperf"

/* //krazy:skip */
#line 10 "doctypes.gperf"
struct PubIDInfo {
    enum eMode {
