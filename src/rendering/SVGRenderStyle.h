...
{
public:
    static PassRefPtr<SVGRenderStyle> create()
    {
        return adoptRef(new SVGRenderStyle);
    }
    PassRefPtr<SVGRenderStyle> copy() const
    {
    ...
    {
        return (strokePaint()->paintType() != SVGPaintImpl::SVG_PAINTTYPE_NONE);
    }
    bool hasFill() const
    {
        return (fillPaint()->paintType() != SVGPaintImpl::SVG_PAINTTYPE_NONE);
    }
