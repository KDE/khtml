...
{
    if (impl) {
        ((ElementImpl *)impl)->setAttribute(ATTR_COORDS, value);
    }
}
...
{
    if (impl) {
        ((ElementImpl *)impl)->setAttribute(ATTR_HREF, value);
    }
}
...
{
    if (impl) {
        ((ElementImpl *)impl)->setAttribute(ATTR_SHAPE, value);
    }
}
...
{
    if (impl) {
        ((ElementImpl *)impl)->setAttribute(ATTR_TARGET, value);
    }
}
...
{
    if (impl) {
        static_cast<HTMLImageElementImpl *>(impl)->setAttribute(ATTR_BORDER, QString::number(value));
    }
}
#endif
...
{
    if (impl) {
        static_cast<HTMLImageElementImpl *>(impl)->setAttribute(ATTR_BORDER, value);
    }
}
...
{
    if (impl) {
        ((HTMLImageElementImpl *)impl)->setHeight(value);
    }
}
...
{
    if (impl) {
        static_cast<ElementImpl *>(impl)->setAttribute(ATTR_VSPACE, QString::number(value));
    }
}
...
{
    if (impl) {
        ((HTMLImageElementImpl *)impl)->setWidth(value);
    }
}
...
{
    if (impl) {
        return static_cast<const HTMLImageElementImpl *>(impl)->x();
    }
    return 0;
}
...
{
    if (impl) {
        return static_cast<const HTMLImageElementImpl *>(impl)->y();
    }
    return 0;
}
