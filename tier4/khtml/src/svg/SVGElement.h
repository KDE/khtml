...
namespace WebCore {
    ...
    public:
        ...
        virtual bool isShadowNode() const { return false; /*FIXME khtml return m_shadowParent;*/ }
        ...
        // KHTML compatibility
        virtual void close() { finishParsingChildren(); Element::close(); }
        ...
        virtual void parseAttribute(Attribute* attr) { parseMappedAttribute(attr); }
